...
$timm = time();
/////////////////////
$sqlCommanda = "INSERT INTO pro_selfie VALUES('', '$user','$resized_fit','$resized_file','$datenow','$timm','')";  
$querya = $db->query($sqlCommanda) or die ($db->error());  
//////////////////

///////////// Notify followers
$sqlCommxo = "INSERT INTO posts VALUES('','','$timm','$user','$user','$resized_fit','','','profilepic','','$datenow','','','','','','','','','','','','')";  
$querox = $db->query($sqlCommxo) or die ($db->error()); 
////////////

$picx = $db->query("UPDATE users SET profilecrop_pic='$resized_file', profile_pic='$resized_fit' WHERE username='$user'");

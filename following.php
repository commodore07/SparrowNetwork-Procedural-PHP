...
?>             
        ...
        <div class="timeline-cover" style="background: url('<?php echo $back_pic; ?>') no-repeat;">
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                ...
                <ul class="list-inline profile-menu">
                  ...
                  <li><a href="following?u=<?php echo $username; ?>" class="active">Following</a><span class="text-green"><?php echo $folli; ?></span></li>
...
<?php 
$getmag = $db->query("SELECT * FROM follows WHERE follower='$username' ORDER BY id DESC") or die($db->error());
$info = $getmag->num_rows;

$getposts = $db->query("SELECT * FROM follows WHERE follower='$username' ORDER BY id DESC LIMIT 10" ) or die($db->error());
include("follow2_loop.php");
?>
</div>
                ...
                $(document).ready(function(){
                    ...
                    $("#readmore").on("click", function () {
                         ...
                         $.post("ajaxfollow2.php?U=<?php echo $username; ?>",{load:loadclick},function(data){
                           $('.images').append(data);
                           $('.procin').hide();
                           $('#readmore').show();
                         });
...
?> 
                ...
                <center><div style="font-size: 14px; color: #999;">Not following anybody yet...</div></center>
<?php 
}
?>                      
            </div>

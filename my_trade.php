...
<?php 
$getmag = $db->query("SELECT * FROM tradefair WHERE la_activ='on' ORDER BY id DESC") or die($db->error());
$info = $getmag->num_rows;

$getposts = $db->query("SELECT * FROM tradefair WHERE la_activ='on' ORDER BY id DESC LIMIT 10" ) or die($db->error());
...
?>
                ...
                $(document).ready(function(){
                    ...
                    $("#readmore").on("click", function () {
                         ...
                         $.post("ajaxtradefair.php?U=<?php echo $username; ?>",{load:loadclick},function(data){
                           $('.images').append(data);
                           $('.procin').hide();
                           $('#readmore').show();
                         });

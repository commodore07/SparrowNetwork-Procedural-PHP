...
<?php 
$i = "";	  								  
$sql_follow = "SELECT * FROM follows WHERE followe='$user'";								  
...
foreach ($follzie as $each){
    ...
    if ($i == 1)
    {
        $query_follow .= " username = '$each' && unmatched_ph !='' && unmatched_ph != '0' && spar_coun='$sparconnn'";
        //echo $query_follow.'<p>&nbsp;</p>';
    }     
    else
    {
        $query_follow .= "OR username = '$each' && unmatched_ph !='' && unmatched_ph != '0' && spar_coun='$sparconnn'";	 
...
?>
                ...
                $(document).ready(function(){
                    ...
                    $("#readmore").on("click", function () {
                         ...
                         $.post("ajax_phpool.php",{load:loadclick},function(data){
                           $('.images').append(data);
                           $('.procin').hide();
                           $('#readmore').show();
                         });

                          ...
                          <div class="post-content">
                            ...
                            <!-- image cropping -->
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <form id="upload_form" action="ponzee_upload_parser.php" method="post" enctype="multipart/form-data">
                                    <div class="docs-data">
                          ...
                          <div class="post-content">
                            ...
                            <!-- image cropping -->
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <!-- <h3 class="page-header">Data:</h3> -->
                                    <form action="ponzee_upload_background.php" id="upload_back" method="post" enctype="multipart/form-data">
                                    <div class="docs-data">
                                      <div class="input-group">

...
if ($cvazz == 0){
$sqlCommand = "INSERT INTO posts VALUES('',?,'$timm','$added_by','$user_posted_to','$resized_file','','','crimson','','$date_added','$adcode','','','','','$posta_staz','','','','','','')";  
...
$sqlCommanda = "INSERT INTO posts VALUES('',?,'$timm','$added_by','$user_posted_to','$resized_file','','','crimson','','$date_added','$adcode','','','','','$posta_staz','','','','','','')";  
...
//// End database insert query
 ...
 //////////////////////// END USER LOGIN  
    ?>
<?php 
$getposts = $db->query("SELECT * FROM posts WHERE empty1='crimson' && date_added > '$lastpost' ORDER BY id DESC " ) or die($db->error());

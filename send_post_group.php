...
///// GET ADSENSE CODE    
$get_adsense = $db->query("SELECT * FROM posts WHERE user_posted_to='$username' AND wall='wall' AND date_added > '$adpost' ORDER BY id DESC LIMIT 3");
...
if ($cvazz == 0){
$sqlCommand = "INSERT INTO posts VALUES('',?,'$timm','$added_by','$user_posted_to','$resized_file','','wall','','','$date_added','$adcode','','','','','$posta_staz','','','','','','')";  
...
$sqlCommanda = "INSERT INTO posts VALUES('',?,'$timm','$added_by','$user_posted_to','$resized_file','','wall','','','$date_added','$adcode','','','','','$posta_staz','','','','','','')";  
...
//// End database insert query
 ...
 //////////////////////// END USER LOGIN  
    ?>
<?php 
$getposts = $db->query("SELECT * FROM posts WHERE user_posted_to='$username' AND wall='wall' && date_added > '$lastpost' ORDER BY id DESC" ) or die($db->error());

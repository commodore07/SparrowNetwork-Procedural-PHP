...
$totalxz2 = 0;    
$total_eev2 = $db->query("SELECT * FROM my_customers WHERE seller = '$username' AND search_date='$dateeva'") or die($db->error());
...
//// Total Expenses
$totalxz = 0;    
$total_eev = $db->query("SELECT * FROM my_expenses WHERE username = '$username' AND tran_date='$dateeva'") or die($db->error());
...
///// Total Chirps
$gend_male = $db->query("SELECT * FROM tradefair WHERE username='$user'") or die($db->error());
...
///// Total cost price
$totalxz3 = 0;    
$total_eev3 = $db->query("SELECT * FROM my_customers WHERE seller = '$username' AND search_date='$dateeva'") or die($db->error());

...
<?php 
$follo = strip_tags(@$_POST['pdteeword']);
...
if ($user != "") {
//// GET PRICE
$get_prixe = $db->prepare("SELECT * FROM my_customers WHERE product_id=? AND seller=?");
$get_prixe->bind_param("ss", $follo, $username);
$get_prixe->execute();
$get_prixe = $get_prixe->get_result();

$cotprixe = $get_prixe->num_rows;
if($cotprixe > 0 && $follo != ""){
           ...
           <div class="grid-item col-md-6 col-sm-6">
            	  <div class="media-grid">
                    ...
                    <div class="media-info">
                      ...
                      <div class="user-info">
                        ...
                        <div class="pull-right"><i class="fa fa-clock-o"></i> <?php echo $caldate; ?> </div>
               ...
               <div class="post-detail">
                  <div class="user-info">
                    ...
                    <p class="text-muted"><i class="icon ion-ios-location"></i> <?php echo $counz; ?></p>
                  </div>
               </div>
            	</div>
...
<?php 
    ...
    echo "<center>No tansaction record found!</center>";
}
}
?>

...
<p style="padding: 10px;"><?php echo $body; ?></p>
         ...
         function metoggle<?php echo $id; ?>() {
           ...
           else
           {
             ele.style.display = 'block';
                ...
                <a style="cursor: pointer; font-size: 20px;" onclick="metoggle<?php echo $id; ?>()" title="More options" class="btn text-green"><i class="fa fa-ellipsis-h"></i></a>

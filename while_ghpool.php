...
$(document).ready(function() {
    ...
    document.getElementById("pavoq").innerHTML="<?php echo $user; ?>";
    document.getElementById("revevdisp").innerHTML = "<center><img src='./loader2.gif'></center>";      
    var rejid = "<?php echo $followe; ?>";
    $.post('matt_disp.php?amvo=<?php echo $zazezu; ?>&&pavo=<?php echo $user; ?>',{rejid: rejid},function(data) {
        $("#revevdisp").html(data);
    });
});
});
                        ...
                        <a id="deqoe<?php echo $id; ?>" title="pay @<?php echo $usename; ?>" class="text-green" style="cursor: pointer;" data-toggle="modal" data-target=".matchreceive"><i class="fa fa-money"></i> Provide help</a><br>                                      
                        
                        Account name: <?php echo $funame; ?> <br>
                        Account number: <?php echo $accnoe; ?> <br>
                        Bank: <?php echo $baknae; ?> <br>
                        Phone number: <?php echo $poknae; ?><br>
                        Amount: <?php echo $renzie; ?><?php echo $umatchgh; ?><br>

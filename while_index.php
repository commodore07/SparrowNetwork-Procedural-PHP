...
?>    
                    ...
                    <li><a target="_blank" href="https://web.facebook.com/sharer/sharer.php?u=http://sparrownetwork.com/<?php echo $id; ?>.html&text=<?php echo $boddie; ?>" title="Share on facebook"><i class="icon ion-social-facebook"></i></a></li>
                    <li><a target="_blank" href="https://twitter.com/share?url=http://sparrownetwork.com/<?php echo $id; ?>.html&text=<?php echo $artu; ?>" title="Share on twitter"><i class="fa fa-twitter"></i></a></li>
                    <li><a target="_blank" href="whatsapp://send?text=http://sparrownetwork.com/<?php echo $id ?>.html" title="Share on whatsapp"><i class="fa fa-whatsapp"></i></a></li>
<?php 
